...
import ReactDOMServer from "react-dom/server"; // this allows to generate html outside a context of a web browser
...
function Shell() {
  return (
    // the components below are wrapped in Context and also on
    // Router because the header needs stuff from context to work while the footer
    // need the links from the other pages such as about us to WORK correctly
